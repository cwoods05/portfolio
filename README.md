# Connor Woods Portfolio

A personal portfolio built with **React**, **Vite**, and **Tailwind CSS**. Features an interactive terminal, smooth animations, and a fully responsive design.
